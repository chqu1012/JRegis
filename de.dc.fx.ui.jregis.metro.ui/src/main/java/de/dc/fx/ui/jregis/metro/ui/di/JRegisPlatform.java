...
public class JRegisPlatform{

	private static final Logger LOG = Logger.getLogger(JRegisPlatform.class.getSimpleName());
	
	private static List<Module> modules = new ArrayList<>();
	private static Injector injector;
	
	static {
		synchronized (JRegisPlatform.class) {
			add(new GlobalModul());
		}
	}

	private JRegisPlatform() {
	}
