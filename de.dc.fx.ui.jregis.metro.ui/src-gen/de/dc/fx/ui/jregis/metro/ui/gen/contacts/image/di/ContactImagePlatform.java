...
public class ContactImagePlatform{
	
	private static final Logger LOG = Logger.getLogger(ContactImagePlatform.class.getSimpleName());
	private static List<Module> modules = new ArrayList<>();
	private static Injector injector;
	
	static {
		synchronized (ContactImagePlatform.class) {
			add(new ContactImageModule());
		}
	}

	private ContactImagePlatform() {
	}
