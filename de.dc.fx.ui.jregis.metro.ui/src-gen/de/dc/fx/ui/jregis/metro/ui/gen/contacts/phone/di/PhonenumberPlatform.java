...
public class PhonenumberPlatform{
	
	private static final Logger LOG = Logger.getLogger(PhonenumberPlatform.class.getSimpleName());
	private static List<Module> modules = new ArrayList<>();
	private static Injector injector;
	
	static {
		synchronized (PhonenumberPlatform.class) {
			add(new PhonenumberModule());
		}
	}

	private PhonenumberPlatform() {
	}
