...
public class ContactGroupPlatform{
	
	private static final Logger LOG = Logger.getLogger(ContactGroupPlatform.class.getSimpleName());
	private static List<Module> modules = new ArrayList<>();
	private static Injector injector;
	
	static {
		synchronized (ContactGroupPlatform.class) {
			add(new ContactGroupModule());
		}
	}

	private ContactGroupPlatform() {
	}
