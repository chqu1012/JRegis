...
public class XAppointmentPlatform{
	
	private static final Logger LOG = Logger.getLogger(XAppointmentPlatform.class.getSimpleName());
	private static List<Module> modules = new ArrayList<>();
	private static Injector injector;
	
	static {
		synchronized (XAppointmentPlatform.class) {
			add(new XAppointmentModule());
		}
	}

	private XAppointmentPlatform() {
	}
