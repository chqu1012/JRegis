...
public class XAppointmentGroupPlatform{
	
	private static final Logger LOG = Logger.getLogger(XAppointmentGroupPlatform.class.getSimpleName());
	private static List<Module> modules = new ArrayList<>();
	private static Injector injector;
	
	static {
		synchronized (XAppointmentGroupPlatform.class) {
			add(new XAppointmentGroupModule());
		}
	}

	private XAppointmentGroupPlatform() {
	}
