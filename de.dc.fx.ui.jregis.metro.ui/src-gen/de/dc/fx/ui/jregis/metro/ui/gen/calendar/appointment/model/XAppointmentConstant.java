...
public class XAppointmentConstant {
  ...
  public static final String SQL_CREATE = "CREATE TABLE IF NOT EXISTS X_APPOINTMENT(ID BIGINT AUTO_INCREMENT, CONTACT_ID VARCHAR, TOPIC VARCHAR, SUMMARY VARCHAR, START TIMESTAMP, END TIMESTAMP, APPOINTMENT_GROUP_ID VARCHAR);";
}
