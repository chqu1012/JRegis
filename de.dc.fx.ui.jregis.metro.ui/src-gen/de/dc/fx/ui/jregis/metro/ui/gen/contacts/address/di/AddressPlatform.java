...
public class AddressPlatform{
	
	private static final Logger LOG = Logger.getLogger(AddressPlatform.class.getSimpleName());
	private static List<Module> modules = new ArrayList<>();
	private static Injector injector;
	
	static {
		synchronized (AddressPlatform.class) {
			add(new AddressModule());
		}
	}

	private AddressPlatform() {
	}
