...
public class DatesPlatform{
	
	private static final Logger LOG = Logger.getLogger(DatesPlatform.class.getSimpleName());
	private static List<Module> modules = new ArrayList<>();
	private static Injector injector;
	
	static {
		synchronized (DatesPlatform.class) {
			add(new DatesModule());
		}
	}

	private DatesPlatform() {
	}
