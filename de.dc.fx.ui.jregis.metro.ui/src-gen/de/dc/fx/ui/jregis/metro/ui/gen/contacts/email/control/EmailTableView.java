...
public class EmailTableView extends TableView<Email>{
	...
	public EmailTableView(EmailFX context, EmailRepository emailRepository) {
		...
		TableColumn<Email, java.lang.String> columnEmail = new TableColumn<>("#EMAIL");
		columnEmail.setPrefWidth(100.0);
		setupCellValueFactory(columnEmail, e->new SimpleObjectProperty<>(e.getEmail()));
		getColumns().add(columnEmail);
