...
public class XAppointmentGroupConstant {
  ...
  public static final String SQL_CREATE = "CREATE TABLE IF NOT EXISTS X_APPOINTMENT_GROUP(ID BIGINT AUTO_INCREMENT, X__APPOINTMENT__GROUP VARCHAR, X__APPOINTMENT__GROUP VARCHAR, X__APPOINTMENT__GROUP VARCHAR, X__APPOINTMENT__GROUP TIMESTAMP, X__APPOINTMENT__GROUP TIMESTAMP, X__APPOINTMENT__GROUP BIGINT);";
}
