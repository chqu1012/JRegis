...
public class ContactConstant {
  ...
  public static final String SQL_INSERT = "INSERT INTO Contact (firstname, lastname, account, avatarId) VALUES (?, ?, ?, ?)";
  ...
  public static final String SQL_CREATE = "CREATE TABLE IF NOT EXISTS Contact(ID BIGINT AUTO_INCREMENT, Firstname String, Lastname String, Account String, AvatarId Long);";
}
