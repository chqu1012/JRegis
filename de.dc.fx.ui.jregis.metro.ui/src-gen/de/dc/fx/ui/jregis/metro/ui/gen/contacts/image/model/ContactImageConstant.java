...
public class ContactImageConstant {
  ...
  public static final String SQL_INSERT = "INSERT INTO CONTACT_IMAGE (NAME, CREATED_ON) VALUES (?, ?)";
  ...
  public static final String SQL_CREATE = "CREATE TABLE IF NOT EXISTS CONTACT_IMAGE(ID BIGINT AUTO_INCREMENT, CONTACT__IMAGE VARCHAR, CONTACT__IMAGE TIMESTAMP);";
}
