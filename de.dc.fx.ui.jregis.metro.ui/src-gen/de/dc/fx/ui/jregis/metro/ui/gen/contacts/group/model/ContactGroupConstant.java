...
public class ContactGroupConstant {
  ...
  public static final String SQL_INSERT = "INSERT INTO CONTACT_GROUP (NAME, STATUS, CREATED_ON, UPDATED_ON) VALUES (?, ?, ?, ?)";
  ...
  public static final String SQL_CREATE = "CREATE TABLE IF NOT EXISTS CONTACT_GROUP(ID BIGINT AUTO_INCREMENT, NAME VARCHAR, STATUS BIGINT, CREATED_ON TIMESTAMP, UPDATED_ON TIMESTAMP);";
}
