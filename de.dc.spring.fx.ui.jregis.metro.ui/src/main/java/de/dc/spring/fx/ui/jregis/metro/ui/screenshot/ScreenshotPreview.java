package de.dc.spring.fx.ui.jregis.metro.ui.screenshot;
...
public class ScreenshotPreview extends BaseScreenshotPreview {
	...
	public static final String FXML = "/de/dc/spring/fx/ui/jregis/metro/ui/screenshot/ScreenshotPreview.fxml";
	...
	protected void onButtonExport(ActionEvent event) {
       ...
       EventBroker.getDefault().post(new EventContext<>("/store/add/screenshot/image", new ScreenshotContext(image," "+ name)));
