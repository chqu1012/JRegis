...
@Component
public class ContactEmailFormular extends VBox{

	@Autowired private ContactEmailFX context;
	...
	public void onButtonSubmit(MouseEvent e) {
		ContactEmail contactEmail = context.getContactEmail ();
		contactEmailRepository.save(contactEmail);
		context.getMasterData().add(contactEmail);
		context.clear();
	}
}
