...
public class ContactSearchPane extends VBox{
	...
	public static final String FXML = "/de/dc/spring/fx/ui/jregis/metro/ui/gen/contacts/contact/filter/ContactSearchPane.fxml";
	...
	public ContactSearchPane() {
		...
		comboboxFirstname.getSelectionModel().selectFirst();
		...
		comboboxLastname.getSelectionModel().selectFirst();
		...
		comboboxUsername.getSelectionModel().selectFirst();
		...
		comboboxContactImageId.getSelectionModel().selectFirst();
		...
		comboboxContactGroupId.getSelectionModel().selectFirst();
		...
		comboboxEmails.getSelectionModel().selectFirst();
		...
		comboboxAddressList.getSelectionModel().selectFirst();
		...
		comboboxPhoneList.getSelectionModel().selectFirst();
		...
		comboboxDateList.getSelectionModel().selectFirst();
	}
