...
@Component
public class ContactDatesFormular extends VBox{

	@Autowired private ContactDatesFX context;
	@Autowired private ContactDatesRepository contactDatesRepository;
	...
	public void onButtonSubmit(MouseEvent e) {
		ContactDates contactDates = context.getContactDates ();
		contactDatesRepository.save(contactDates);
		context.getMasterData().add(contactDates);
		context.clear();
	}
}
