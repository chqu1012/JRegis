...
@Component
public class ContactAddressFormular extends VBox{

	@Autowired private ContactAddressFX context;
	@Autowired private ContactAddressRepository contactAddressRepository;
	...
	public void onButtonSubmit(MouseEvent e) {
		ContactAddress contactAddress = context.getContactAddress ();
		contactAddressRepository.save(contactAddress);
		context.getMasterData().add(contactAddress);
		context.clear();
	}
}
